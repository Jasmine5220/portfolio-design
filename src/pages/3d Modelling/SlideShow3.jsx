...
import IndustrialDesign from "../IndustrialDesign";
import "../SlideShow.css";

const Slideshow3 = () => {
  // List of components
  const components = [<GenericFontPage backgroundNumber="03" mainTitle="3D Modelling" subtitle="Research | Ideation | Execution" />, <IndustrialDesign />];
